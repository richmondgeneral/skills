...
**After completion:** Returns to rg-inventory, resume at Phase 2 (Photography)
...
* Scope: Identification only (maker, date, confidence), defer valuation to rg-inventory
...
* Defers: Valuation, condition assessment to rg-inventory Phase 1 research checklist
**After completion:** Returns to rg-inventory, continue Phase 1 for valuation
...
* General items use rg-inventory Phase 1 research checklist

**listing-writer** → marketplace-templates.md in rg-inventory/references/
* Keep listing templates in rg-inventory context
...
* Integration point: Returns to rg-inventory at Phase 2 (Photography)
...
- [x] Integrates with rg-inventory Phase 1
- [x] rg-inventory Phase 1 routing updated
- [x] rg-inventory Related Skills section updated
...
### Phase 3: Update rg-inventory integration (COMPLETED)
**Updated Phase 1 routing in rg-inventory/SKILL.md:**
Before:
```markdown
...
carnival-glass-appraiser
  ...
  └─ Returns to rg-inventory with complete appraisal
      ↓
rg-inventory resumes at Phase 2: Photography
...
maker-mark-identifier
  ...
  └─ Returns: Maker ID only (no valuation)
      ↓
rg-inventory continues Phase 1 research checklist:
  ├─ Assess condition
  ├─ Research comparable sales (eBay sold, auction records)
  └─ Determine price point
      ↓
rg-inventory continues at Phase 2: Photography, etc.
```
...
book-appraiser (unchanged, already complete)
  ...
  └─ Returns to rg-inventory with complete appraisal
      ↓
rg-inventory resumes at Phase 2: Photography, etc.
```
## Testing Strategy
...
* Carnival glass workflow: rg-inventory → carnival-glass-appraiser → resume Phase 2
* Pottery mark workflow: rg-inventory → maker-mark-identifier → continue Phase 1 → Phase 2
* Book workflow: rg-inventory → book-appraiser → resume Phase 2

**Test rg-inventory routing (TVM-24 test cases):**
...
5. Appraisal completes → rg-inventory resumes at Phase 2 (Photography)
## Migration Notes
