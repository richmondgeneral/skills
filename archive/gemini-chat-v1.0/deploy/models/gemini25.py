...
class Gemini25FlashModel(BaseModel):
    """Gemini 2.5 Flash image processing model."""
    
    def __init__(self, api_key: str = None):
        super().__init__(api_key or os.getenv('GEMINI_API_KEY'))
        self.endpoint = 'gemini-2.5-flash'
        self.base_url = 'https://generativelanguage.googleapis.com/v1beta'
    
    def get_capabilities(self) -> Dict[str, Any]:
        """Return Gemini 2.5 Flash capabilities."""
        return {
    ...
    def process_image(self, image_path: str, task_config: TaskConfig) -> ProcessingResult:
        ...
        try:
            ...
            elif task_config.task_type == 'analyze':
    ...
    def _remove_background(self, image_path: str, task_config: TaskConfig, start_time: float) -> ProcessingResult:
        """Remove background using Gemini 2.5 Flash."""
        # Get subject bounds from Gemini
    ...
    def _detect_subject(self, image_path: str) -> Dict[str, Any]:
        """Detect subject bounds using Gemini 2.5 Flash."""
