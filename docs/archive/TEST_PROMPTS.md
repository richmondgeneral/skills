...
**Expected:**
- Lists rg-full-auto as main orchestrator
...
- Returns to rg-full-auto at Phase 2
...
- Explicitly defers valuation to rg-full-auto
...
4. Guides to continue rg-full-auto Phase 1 for:
...
- ✅ Clear handoff back to rg-full-auto
...
**Validation:**
- ✅ Uses marketplace-templates from rg-full-auto
...
**Prompt:**
```
Show me where square-cache integrates with the rg-full-auto workflow.
```
...
- Notes rg-full-auto designed for single-item flow
