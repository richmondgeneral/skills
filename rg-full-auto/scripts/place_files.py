...
def place_files(
    ...
    Args:
        ...
        repo_path: Path to GitHub repo items directory (default: ~/Workspace/items)
    ...
    # Resolve repo path
    if not repo_path:
        repo_path = Path.home() / "Workspace" / "items"
    else:
...
def main():
    ...
    parser.add_argument(
        '--repo-path',
        help='Path to GitHub repo items directory (default: ~/Workspace/items)'
    )
