...
~/skills/square-crm/scripts/update_contact_simple.sh "+13129143889" "Mike Giba" "+17085970480"

# Just update name
~/skills/square-crm/scripts/update_contact_simple.sh "+13129143889" "Mike Giba"
```
...
- Check `~/skills/square-crm/scripts/` for other tools
